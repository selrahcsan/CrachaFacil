...
class Ui_Widget(object):
    def setupUi(self, Widget):
        ...
        Widget.setFont(font)
        icon = QIcon()
        icon.addFile(u":/PNG/Imgs/logo.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon1 = QIcon()
        icon1.addFile(u":/PNG/Imgs/portal.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btn_inserir_funcionario.setIcon(icon1)
        ...
        icon2 = QIcon()
        icon2.addFile(u":/PNG/Imgs/excel.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btn_importar_exel.setIcon(icon2)
        ...
        icon3 = QIcon()
        icon3.addFile(u":/PNG/Imgs/user.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btn_atualizar.setIcon(icon3)
        ...
        icon4 = QIcon()
        icon4.addFile(u":/Imgs/Imgs/warning.ico", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.voltar.setIcon(icon4)
        ...
        icon5 = QIcon()
        icon5.addFile(u":/Imgs/Imgs/check.ico", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.cadastrar.setIcon(icon5)
        ...
        icon6 = QIcon()
        icon6.addFile(u":/Imgs/Imgs/move - Copia.ico", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btn_retroceder.setIcon(icon6)
        ...
        icon7 = QIcon()
        icon7.addFile(u":/Imgs/Imgs/move.ico", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btn_avancar.setIcon(icon7)
        ...
        icon8 = QIcon()
        icon8.addFile(u":/Imgs/Imgs/magnifier.ico", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.localizar.setIcon(icon8)
        ...
        icon9 = QIcon()
        icon9.addFile(u":/Imgs/Imgs/editor.ico", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.editar_localizar.setIcon(icon9)
        ...
        self.atualizar_localizar.setIcon(icon3)
        ...
        self.voltar_localizar_menu_inicial.setIcon(icon4)
        ...
        icon10 = QIcon()
        icon10.addFile(u":/Imgs/Imgs/users.ico", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon11 = QIcon()
        icon11.addFile(u":/PNG/Imgs/bancoDeDados.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btn_criar_banco_sqlite.setIcon(icon11)
        ...
        icon12 = QIcon()
        icon12.addFile(u":/PNG/Imgs/bancoDeDados_deletar.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.deletar_banco.setIcon(icon12)
        self.deletar_banco.setIconSize(QSize(256, 256))
        icon13 = QIcon()
        icon13.addFile(u":/Imgs/Imgs/settings.ico", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
    ...
    def retranslateUi(self, Widget):
        Widget.setWindowTitle(QCoreApplication.translate("Widget", u"Crach\u00e1F\u00e1cil - 0.0.1", None))
