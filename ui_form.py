...
class Ui_Widget(object):
    def setupUi(self, Widget):
        ...
        self.voltar.setGeometry(QRect(500, 340, 181, 51))
        icon3 = QIcon()
        ...
        self.layoutWidget.setGeometry(QRect(10, 90, 661, 241))
        ...
        self.cadastrar.setGeometry(QRect(690, 340, 181, 51))
        icon4 = QIcon()
        ...
        self.layoutWidget1.setGeometry(QRect(10, 90, 661, 234))
        ...
        self.layoutWidget2.setGeometry(QRect(0, 340, 771, 46))
        ...
        icon5 = QIcon()
        icon5.addFile(u":/Imgs/Imgs/users.ico", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.criar_banco_sqlite = QPushButton(self.groupBox_6)
        self.criar_banco_sqlite.setObjectName(u"criar_banco_sqlite")
        self.criar_banco_sqlite.setGeometry(QRect(30, 40, 281, 291))
        icon6 = QIcon()
        icon6.addFile(u":/PNG/Imgs/bancoDeDados.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.criar_banco_sqlite.setIcon(icon6)
        self.criar_banco_sqlite.setIconSize(QSize(256, 256))
        ...
        icon7 = QIcon()
        icon7.addFile(u":/PNG/Imgs/bancoDeDados_deletar.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.deletar_banco.setIcon(icon7)
        self.deletar_banco.setIconSize(QSize(256, 256))
        icon8 = QIcon()
        icon8.addFile(u":/Imgs/Imgs/settings.ico", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
